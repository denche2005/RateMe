            ...
            return (
              ...
              >
                <div className={`flex flex-col ${msg.isOwn ? 'items-end' : 'items-start'}`}>
                  <div
                    className={`max-w-[70%] rounded-2xl text-[14px] font-medium leading-relaxed tracking-wide shadow-sm overflow-hidden ${msg.isOwn
                ...
                {userResponse && (
                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10 filter drop-shadow-md transition-transform duration-200 active:scale-95">
                    ...
                    >
                      ...
                      <div className={`font-bold flex items-center justify-center gap-1 overflow-hidden ${userResponse.type === 'VOTE' ? 'text-[10px]' : 'text-[9px] leading-3 line-clamp-2 break-words text-ellipsis'
                        }`}>
                  ...
                  <div className="relative pt-4">
                    ...
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10 filter drop-shadow-md transition-transform duration-200 active:scale-95">
                      ...
                      >
                        ...
                        <div className={`font-bold flex items-center justify-center gap-1 overflow-hidden ${isVote ? 'text-[10px]' : 'text-[9px] leading-3 break-words text-ellipsis'
                          }`}>
                          {/* NEW MINIMALIST SVG ICON (Replacing emoji) */}
                          {isVote && (
              ...
              return (
                ...
                >
                  ...
                  {isDescribed ? (
                    ...
                    // RATING/COMMENT/REPLY/SAVED/REPOSTED: Post + Score/Emoji (click → ver post)
                    <div
                      onClick={() => {
                    ...
                    >
                      ...
                      {/* Score badge en esquina OR Comment emoji */}
                      {(isComment || isReply) ? (
