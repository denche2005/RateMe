...
export const CommentsSheet: React.FC<Props> = ({ comments, users, onClose, onAddComment, onLikeComment, likedCommentIds = [] }) => {
             ...
             return (
               <div key={comment.id} className="flex gap-3">
                  ...
                  <div className="flex-1">
                     ...
                     <p className="text-sm text-theme-text leading-tight mt-0.5">{comment.text}</p>
                     
                     <div className="flex items-center gap-4 mt-2">
                        <span className="text-xs text-theme-secondary font-bold cursor-pointer hover:text-theme-accent">Reply</span>
