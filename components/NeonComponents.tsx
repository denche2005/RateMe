...
export const BackArrow: React.FC<{ onClick?: () => void, className?: string }> = ({ onClick, className = '' }) => {
  return (
    <div
      onClick={onClick}
      className={`w-11 h-11 flex items-center justify-center rounded-2xl bg-theme-bg/40 backdrop-blur-md border border-theme-text/10 text-theme-text hover:bg-theme-text/10 hover:border-theme-accent/50 transition-all active:scale-95 group shadow-sm cursor-pointer ${className}`}
    >
      <svg
